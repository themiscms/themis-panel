...
<div class="box">
    ...
    <div id="dataflex"><img src="../img/data.png" id="datapic">
    <form action="../oprs/register.oprs.php">
        <div style="height: 40px"></div>
        <input type="text" placeholder="First name" name="first_name" required min="5" max="32">
        <input type="text" placeholder="Last name" name="last_name" required min="5" max="32">
        <select id="nation">
